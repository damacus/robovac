...
def test_default_protocol_version_for_old_model(common_args):
...
def test_model_specific_protocol_version_tuple_overrides(common_args):
...
def test_model_specific_protocol_version_float_is_converted(common_args):
