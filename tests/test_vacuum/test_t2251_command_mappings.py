...
def test_t2251_mode_command_values(mock_t2251_robovac):
...
def test_t2251_mode_case_insensitive(mock_t2251_robovac):
...
def test_t2251_fan_speed_command_values(mock_t2251_robovac):
...
def test_t2251_error_code_mapping(mock_t2251_robovac):
...
def test_t2251_model_has_commands(mock_t2251_robovac):
