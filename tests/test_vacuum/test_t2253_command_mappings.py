"""Tests for T2253 command mappings and DPS codes."""
...
def test_t2253_mode_command_values(mock_t2253_robovac):
...
def test_t2253_mode_case_insensitive(mock_t2253_robovac):
...
def test_t2253_fan_speed_command_values(mock_t2253_robovac):
...
def test_t2253_error_code_mapping(mock_t2253_robovac):
...
def test_t2253_model_has_commands(mock_t2253_robovac):
    """Test that T2253 model has required commands defined."""
    commands = mock_t2253_robovac.model_details.commands
