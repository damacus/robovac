...
def test_t2252_mode_command_values(mock_t2252_robovac):
...
def test_t2252_mode_case_insensitive(mock_t2252_robovac):
...
def test_t2252_fan_speed_command_values(mock_t2252_robovac):
...
def test_t2252_error_code_mapping(mock_t2252_robovac):
...
def test_t2252_model_has_commands(mock_t2252_robovac):
